                ...
                >
                  <div className="sm:w-48 sm:flex-shrink-0 h-48 sm:h-auto bg-gradient-to-br from-blue-100 to-indigo-100 overflow-hidden">
                    {job.image ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <span className="text-5xl">Job</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex-1 p-5 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span className="flex items-center gap-1 bg-red-50 text-red-500 text-xs px-3 py-1 rounded-full">
                          Expires: {new Date(job.expiry_date).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2 mt-4">
                      ...
                      <button
                        onClick={(e) => handleShare(e, job.job_id)}
                        title="Copy link"
